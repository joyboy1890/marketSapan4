                ...
                <div class="row mt">
                    <div class="col-lg-12">
                        <div class="form-panel">
                            <h4 class="mb"><i class="fa fa-angle-right"></i> โซน A</h4>
                            <form id="frmbooking" class="form-horizontal style-form" method="POST" action="bookingController.php">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <div class="col-md-6 col-md-offset-3">
                                        <img src="img/ZoneA.jpg" class="img-responsive">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 col-sm-2 control-label">ประเภทสินค้า</label>
                                    <div class="col-sm-10">
                                        <label class="control-label">อาหารสด</label>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="number" name="booking_price" class="form-control" value="250" readonly>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <button type="submit" name="bookingZoneA" class="btn btn-success">บันทึก</button>
                                    </div>
                                </div>
                            </form>
                        </div>
