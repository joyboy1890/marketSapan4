                    ...
                    <div class="col-lg-12">
                        <div class="form-panel">
                            ...
                            <form class="form-horizontal style-form" method="POST" action="regularController.php">
                                <input type="hidden" class="form-control" readonly name="reg_id"
                                    value="<?php echo $result["reg_id"]; ?>">
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">ชื่อ</label>
                                    <div class="col-sm-4">
                                        <input class="form-control" readonly name="reg_fname"
                                            value="<?php echo $result["reg_fname"]; ?>">
                                    </div>
                                    <label class="col-sm-1 control-label">นามสกุล</label>
                                    <div class="col-sm-5">
                                        <input class="form-control" readonly name="reg_lname"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" readonly name="reg_id_card"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" readonly name="reg_tel"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select name="reg_zone" class="form-control" readonly>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select name="type_product_id" class="form-control" readonly>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="number" class="form-control" readonly name="reg_amount_log" value="<?php echo $result["reg_amount_log"]; ?>">
                                    </div>
                                    <label class="col-sm-1 control-label">เลขล็อค</label>
                                    <div class="col-sm-2">
                                        <input type="number" class="form-control" readonly name="reg_log_1" value="<?php echo $result["reg_log_1"]; ?>">
                                    </div>
                                    <div class="col-sm-2">
                                        <input type="number" class="form-control" readonly name="reg_log_2" value="<?php echo $result["reg_log_2"]; ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 col-sm-2 control-label">ราคาเช่า</label>
                                    <div class="col-sm-10">
                                        <input type="number" class="form-control" readonly name="reg_price" value="<?php echo $result["reg_price"]; ?>">
                                    </div>
                                </div>
                                <!-- <div class="form-group">
                                    <label class="col-sm-2 col-sm-2 control-label">วันที่เริ่มขาย</label>
                                    <div class="col-sm-10">
                                        <input type="date" class="form-control" readonly name="reg_create_date"  value="">
                                    </div>
                                </div> -->
                                <div class="form-group">
