                        ...
                        <div class="form-panel">
                            ...
                            <form class="form-horizontal style-form" method="POST" action="regularController.php">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea class="form-control" cols="30" rows="5" name="reg_address"></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select name="type_product_id" class="form-control">
                                            <option value="ประเภทอาหารสด">ประเภทอาหารสด</option>
                                            <option value="ประเภทกับข้าวสำเร็จรูป">ประเภทกับข้าวสำเร็จรูป</option>
                                            <option value="ประเภทเสื้อผ้าและของใช้">ประเภทเสื้อผ้าและของใช้</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="number" class="form-control" name="reg_amount_log">
                                    </div>
                                    <label class="col-sm-1 control-label">เลขล็อค</label>
                                    <div class="col-sm-2">
                                        <input type="number" class="form-control" name="reg_log_1">
                                    </div>
                                    <div class="col-sm-2">
                                        <input type="number" class="form-control" name="reg_log_2">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 col-sm-2 control-label">ราคาเช่า</label>
                                    <div class="col-sm-10">
                                        <input type="number" class="form-control" name="reg_price">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 col-sm-2 control-label">วันที่เริ่มขาย</label>
                                    <div class="col-sm-10">
                                        <input type="date" class="form-control" name="reg_create_date">
                                    </div>
                                </div>
                                <div class="form-group">
