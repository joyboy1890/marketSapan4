                    ...
                    <div class="col-lg-12">
                        <div class="form-panel">
                            ...
                            <form class="form-horizontal style-form" method="POST" action="regularController.php">
                                <input type="hidden" class="form-control" readonly name="irreg_id"
                                    value="<?php echo $result["irreg_id"]; ?>">
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">ชื่อ</label>
                                    <div class="col-sm-4">
                                        <input class="form-control" readonly name="irreg_fname"
                                            value="<?php echo $result["irreg_fname"]; ?>">
                                    </div>
                                    <label class="col-sm-1 control-label">นามสกุล</label>
                                    <div class="col-sm-5">
                                        <input class="form-control" readonly name="irreg_lname"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" readonly name="irreg_id_card"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" readonly name="irreg_tel"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" readonly name="irreg_username"
                                            value="<?php echo $result["irreg_username"]; ?>">
                                    </div>
                                </div>
                                <div class="form-group">
